...
fn tuple_struct() {
    #[derive(Validate)]
    struct Test(#[vate(CompareEQ(5))] i32);
}
...
fn nested_tuple_structs() {
    ...
    #[derive(Validate)]
    struct Test2(#[vate(CompareEQ(5))] i32);
}
...
fn tuple_struct_multiple_fields() {
    #[derive(Validate)]
    struct Test(#[vate(CompareEQ(5))] i32, #[vate(CompareEQ(5))] i32);
}
...
fn tuple_struct_field_exposure() {
    #[derive(Validate)]
    struct Test(i32, #[vate(CompareEQ(fields.0))] i32);
}
...
fn unnamed_variant_enum_multiple_fields() {
    #[derive(Validate)]
    enum Test {
        A(#[vate(CompareEQ(5))] i32, #[vate(CompareEQ(5))] i32),
    }
}
...
fn unnamed_variant_enum_field_exposure() {
    #[derive(Validate)]
    enum Test {
        A(i32, #[vate(CompareEQ(fields.0))] i32),
    }
}
